<template>
  <div class="container backdrop">
    ...
    <el-card class="box-card" style="margin: 20px auto;width: 90%; height: 85%">
      <el-divider content-position="left"><span style="font-size: 14px">RETAILER INFORMATION</span></el-divider>
      <el-form :model="form" label-width="120px">
        ...
        <el-form-item label="名称" prop="retailer_name">
          <el-input v-model="form.retailer_name" autocomplete="off" style="width: 280px"/>
        </el-form-item>
        <el-form-item label="类型" prop="retailer_type">
          <el-input v-model="form.retailer_type" autocomplete="off" style="width: 280px"/>
        </el-form-item>
        <el-row>
          <el-form-item label="电话" prop="retailer_phone">
            <el-input v-model="form.retailer_phone" autocomplete="off" style="width: 280px"/>
          </el-form-item>
          <el-form-item label="邮箱" prop="retailer_email">
            <el-input v-model="form.retailer_email" autocomplete="off" style="width: 280px"/>
          </el-form-item>
        </el-row>
        <el-form-item label="地址">
          <el-input v-model="form.retailer_address" autocomplete="off" style="width: 280px"

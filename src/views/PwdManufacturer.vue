<template>
  <div class="container backdrop">
    ...
    <el-card class="box-card" style="margin: 20px auto;width: 90%; height: 85%">
      <el-divider content-position="left"><span style="font-size: 14px">MANUFACTURER PASSWORD</span></el-divider>
      <el-form :model="form" label-width="120px" :rules="rules" ref="newPwd">
        ...
        <el-form-item label="名称" prop="manufacturer_name">
          <el-input v-model="form.manufacturer_name" autocomplete="off" style="width: 280px" :disabled="true"/>
        </el-form-item>
